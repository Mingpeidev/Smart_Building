...
;!function(e) {
	...
	o.prototype.cache = n, o.prototype.define = function(e, t) {
		...
		if (t = t || "layui", o = o || localStorage, e.JSON && e.JSON.parse) {
			...
			n = "object" == typeof n ? n : {
				...
				delete r[n.key]
				, o[t] = JSON.stringify(r), n.key ? r[n.key] : r
		}
	...
	M.prototype.config = {
		...
		var e = this,
			...
			o = t.width || function() {
				var e = function(i) {
					var a,
						l;
					i = i || t.elem.parent(), a = i.width();try {
						l = "none" === i.css("display")
					} catch (n) {} return !i[0] || a && !l ? a : e(i.parent())
				};
				return e()
			}();
		e.eachCols(function() {
		...
		delete c.sortKey
		), u[h.response.dataName] = r, c.renderData(u, c.page, c.count, !0), l && layui.event.call(e, s, "sort(" + f + ")", {
			field : n,
			type : i
		})
